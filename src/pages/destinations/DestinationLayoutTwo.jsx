...
const DestinationLayoutTwo = ({ data }) => {
    return (
        <>
            <Link to={'/packages/' + data.url}>


                <div className="w-full group border border-white hover:border-primary relative rounded-lg overflow-hidden">
                    <button className='size-10 bg-white z-50 rounded-full shadow-md shadow-white/50 absolute top-3 end-3 flex items-center justify-center'>
                        <RightOutlined />
                    </button>
