...
const SearchFlightComponent = () => {
    ...
    const query = searchdata.data.searchQuery;
    const [travellers, setTravellers] = useState(query.paxInfo);
    const boxRef = useRef(null);
    const [cabinClass, setCabinClass] = useState(query.cabinClass);
