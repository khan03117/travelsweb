                ...
                details && (
                    <>
                        ...
                        <section className="space ticket ticketborder">
                            {
                                (details?.payment_status == "CHARGED" && details?.booking_status == "Success") && (
                                    <>
                            ...
                            {
                                (details?.payment_status == "CHARGED" && !details?.booking_status) && (
                                    <>
                                        <div className="w-full " id="bill-content">
                                            <table className="table *:text-xs">
                                                <thead>
                                                ...
                                                <tbody>
                                                    <tr className='*:p-2 *:border *:border-blue-gray-300'>
                                                        ...
                                                        <td>{details?.bookingQuery?.paymentInfos[0]?.amount}</td>
                                                        <td>
                                                            Paid
                                                        </td>
                                                        <td>
                            ...
                            {
                                (!details?.payment_status && !details?.booking_status) && (
                                    <>
                                        <div className="w-full " id="bill-content">
                                            <table className="table *:text-xs">
                                                <thead>
