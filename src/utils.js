// export const BASE_URL = `http://localhost/laravel/aahilapi/`;
// export const API_URL = `http://localhost/laravel/aahilapi/api/`;


export const BASE_URL = "https://b2b.aahiltours.com/";
